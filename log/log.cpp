    ...
    int split_lines, int max_queue_size)
{
    ...
    if(max_queue_size >= 1) {
        ...
        // flush_log_thread为线程工作函数，表示创建线程异步写日志
        pthread_t tid;
...
void Log::write_log(int level, const char *format, ...)
{
    ...
    // m_is_async 为 true 表示异步，默认为同步
    // 异步，则将日志信息加入阻塞队列；同步，则加锁向文件中写入
